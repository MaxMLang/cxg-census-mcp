...
as its code of conduct. The full text is reproduced below.
...
requests, discussions, etc.), and also applies when an individual is
...
[https://github.com/MaxMLang](https://github.com/MaxMLang). All complaints
...
1. **Correction** — private warning, with clarity around the violation.
2. **Warning** — public or private warning, with consequences if behavior continues.
